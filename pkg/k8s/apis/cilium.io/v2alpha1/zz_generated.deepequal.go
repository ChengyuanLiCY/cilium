...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumWorldCIDRSet) DeepEqual(other *CiliumWorldCIDRSet) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumWorldCIDRSetSpec) DeepEqual(other *CiliumWorldCIDRSetSpec) bool {
	if other == nil {
		return false
	}

	if ((in.WorldCIDRs != nil) && (other.WorldCIDRs != nil)) || ((in.WorldCIDRs == nil) != (other.WorldCIDRs == nil)) {
		in, other := &in.WorldCIDRs, &other.WorldCIDRs
		if other == nil {
			return false
		}
